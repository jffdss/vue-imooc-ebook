  ...
  <div class="flap-card-wrapper" v-show="flapCardVisible">
      <div class="flap-card-bg" :class="{'animation' : runFlapCardAnimation}" v-show="runFlapCardAnimation">
          ...
          <div class="point-wrapper">
              <div class="point" v-for="item in pointList"
                                :key="item"
                                :class="{'animation' : runPointAnimation}"></div>
          </div>
      </div>
      <div class="book-card" v-show="runBookCardAnimation">
          <div class="book-card-wrapper" :class="{'animation': runBookCardAnimation}">
              <div class="img-wrapper">
                  <img class="img" src="../../../public/cover.jpg">
                </div>
              <div class="content-wrapper">
                  <div class="content-title">{{data ? data.title: ''}}</div>
                  <div class="content-author sub-title-medium">{{data.author}}</div>
                  <div class="content-category" v-show="false">{{categoryText()}}</div>
              </div>
              <div class="read-btn" @click.stop="showBookDetail(book)">{{$t('home.readNow')}}</div>
          </div>
      </div>
...
import { flapCardList, categoryText } from '../../utills/store'
export default {
